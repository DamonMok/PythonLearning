...
class WSGIServer(object):
    ...
    def service_client(self, new_client_socket):
        ...
        if not file_name.endswith(".html"):
            # 2.1 如果请求的资源不是以.html结尾的，就加载静态资源(html/css/js/png/jpg等)
            try:
            ...
            # 2.2 如果路径以.html结尾，则加载动态资源(动态解析)
            # body
            environ = dict()
            environ['PATH_INFO'] = file_name
            body = dynamic.mini_frame10.application(environ, self.set_response_header)
